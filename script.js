      ...
      fetch(
        ...
        .then((info) => {
          ...
          <div id="info-detalle-primaria-imagen"><img src="${comicSeleccionado.thumbnail.path}/portrait_uncanny.${comicSeleccionado.thumbnail.extension}" alt=""></div>
           ...
           <h2>Personajes</h2>
           <span id="cantidad-personajes">0</span><span>RESULTADOS</span>
           </div>
    ...
    personaje.onclick = () => {
      ...
      fetch(
        ...
        .then((info) => {
          ...
          <div id="info-detalle-secundaria-resultados"><h2>Comics</h2><p><span id="cantidad-comics">0</span><span>RESULTADOS</span></p>
          </div>
          <div id="info-detalle-secundaria-comics">
          </div>
          </div>
          `;
